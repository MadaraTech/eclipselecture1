...
public class ArrayTask2 {
	...
	public static void main(String[] args) {
		/*
		 * String[] dayOfWeek = new String[7]; dayOfWeek[0] = "Monday";
		 * dayOfWeek[1] = "Tuesday"; dayOfWeek[2] = "Wednsday";
		 * 
		 * for(String dayName : dayOfWeek){ System.out.println(dayName); }
		 */
		...
		int dayIndex = scanner.nextInt(); // reduce by one to work with zero
											// based indexes
